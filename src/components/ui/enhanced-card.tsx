  ...
  "rounded-xl transition-all duration-200",
  {
    variants: {
      variant: {
        ...
        gradient: "bg-gradient-soft-green-visible text-forge-formationFg border-0 shadow-sm",
        "gradient-brand": "bg-gradient-brand text-white border-0 shadow-md",
        "gradient-success": "bg-gradient-soft-green text-forge-formationFg border-0 shadow-sm",
        "gradient-warning": "bg-gradient-soft-yellow text-forge-formationFg border-0 shadow-sm",
        "gradient-purple": "bg-gradient-soft-purple text-forge-formationFg border-0 shadow-sm",
