            ...
            <div className="text-left relative">
              ...
              <div className="flex items-center gap-3 mb-6">
                <div className="flex items-center gap-2 bg-forge-orange/10 px-4 py-2 rounded-full">
                  ...
                  <span className="text-sm font-semibold text-forge-orange">Forge Your Future</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-6 mb-8">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-forge-gray">6-Month Program</span>
                </div>
                <div className="flex items-center gap-2">
              ...
              >
                <span className="relative z-10">Apply to Join the Next Cohort</span>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl p-4 shadow-lg border border-forge-cream">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium text-forge-dark">Live Coding</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-6 group">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-forge-dark mb-3 flex items-center gap-2">
                      Apply & Get Accepted
                      <BookOpen size={20} className="text-forge-orange opacity-60" />
                    </h3>
                ...
                <div className="flex items-start space-x-6 group">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-forge-dark mb-3 flex items-center gap-2">
                      Learn While Earning
                      <Flame size={20} className="text-forge-orange opacity-60" />
                    </h3>
                ...
                <div className="flex items-start space-x-6 group">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-forge-dark mb-3 flex items-center gap-2">
                      Land Your Dream Job
                      <Blocks size={20} className="text-forge-orange opacity-60" />
                    </h3>
            ...
            <div className="bg-white rounded-3xl p-10 shadow-lg border border-forge-cream relative overflow-hidden">
              ...
              <div className="text-center relative z-10">
                <div className="flex items-center justify-center gap-2 mb-4">
                  ...
                  <h3 className="text-3xl font-bold text-forge-dark">Next Cohort Starts</h3>
                </div>
